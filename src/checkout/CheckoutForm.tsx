  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormItem error={formState.errors.nameSurname}>
        <FormItemLabel htmlFor="nameSurname">Фамілія та Імʼя</FormItemLabel>
        <Input
          id="nameSurname"
      ...
      <FormItem error={formState.errors.cardNumber}>
        <FormItemLabel htmlFor="cardNumber">Номер карти</FormItemLabel>
        <NumberInput
          id="cardNumber"
          format="#### #### #### ####"
          mask="_"
      ...
      <div className="flex justify-between gap-4">
        <FormItem error={formState.errors.expiry}>
          <FormItemLabel htmlFor="expiry">Термін придатності</FormItemLabel>
      ...
      <div className="flex justify-end">
        <SubmitButton formState={formState}>Оформити замовлення</SubmitButton>
      </div>
    </Form>
  );
}
